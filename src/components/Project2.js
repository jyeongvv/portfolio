  ...
  return (
    <div className="project2" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      <Paper style={paperStyle} elevation={0}>
          ...
          <p style={innerTextStyle2}>
          <SquareIcon sx={{ color: grey, fontSize: 8, marginRight: 2 }} /><span className='highlighted-text'>프론트만 제작을 하니 확실히 간편하기도 했지만 무엇보다도 너무 즐겁게 작업하여 개발 분야로 진로를 잡는다면, 프론트엔드로 나아가고 싶다는 생각에 확신이 들었습니다.</span></p>
          <p style={innerTextStyle2}>
          ...
          <p style={innerTextStyle2}>
          <SquareIcon sx={{ color: grey, fontSize: 8, marginRight: 2 }} /><span className='highlighted-text'>이번 포트폴리오 제작을 바탕으로 더 발전된 포트폴리오를 제작할 계획이 있습니다.</span></p>
        </Paper>
      </div>
